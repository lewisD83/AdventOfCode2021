...
int main(int argc, char* argv[])
{
	...
	// We have gamma and epsilon rating as binary string number so convert to decimal int
	...
	// Hold a vector of binary string numbers which will eventually filter down to give the correct CO2 and O2 ratings
